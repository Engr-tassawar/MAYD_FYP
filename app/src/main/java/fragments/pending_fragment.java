...
public class pending_fragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        refreshLayout = view.findViewById(R.id.serviceProviderPendingOrders_refreshLayout);


        refreshLayout.setOnRefreshListener(() -> {
            DbUtil.serviceProviderCompletedOrders.clear();
            RefreshData();
        });
    ...
    private void RefreshData() {
        ...
        pendingAdapter = new PendingAdapter(false,DbUtil.serviceProviderCompletedOrders,getContext());

        recyclerView.setAdapter(pendingAdapter);
        pendingAdapter.notifyDataSetChanged();

        if(DbUtil.serviceProviderCompletedOrders.size() == 0  ){
